    	...
    	<table width="100%" cellspacing="0" cellpadding="0">
            ...
            <!-- content -->
      		<tr style="background-color:rgba(0,0,0,0.1);">
				...
				<div>
                	<h1 style="margin:0px; padding:25px; text-align:center;">About Us:</h1>
                	<p style="padding:10px; padding-bottom:30px; text-align:center;">Founded in June 2016 and based in Hazmieh, Lebanon. <br><br>Libaytak is a trusted community marketplace for people to list and discover unique accommodations around Lebanon. <br><br>Whether an apartment , a studio, or a villa, Libaytak connects people to unique experiences, at any price point, all over the country. Libaytak is the easiest way for people to monetize their extra space and showcase it to an audience of millions.</p>
                </div>
